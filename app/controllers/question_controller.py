...
class QuestionsController:
    ...
    #METODO MOSTRAR TODOS LOS QUESTIONS INACTIVOS
    #--------------------
    # UNICAMENTE VALIDO PARA USUARIOS ADMIN
    #
    @staticmethod
    ...
    def get_inactive_questions():
        ...
        questions = Questions.get_inactive_questions()
        ...
        return jsonify({"preguntas_inactivas": questions}), 200
    
    
    
     #METODO MOSTRAR TODOS LOS QUESTIONS ACTIVOS
    #--------------------
    # UNICAMENTE VALIDO PARA USUARIOS ADMIN
    #
    @staticmethod
    ...
    def get_active_questions():
        ...
        questions = Questions.get_active_questions()
